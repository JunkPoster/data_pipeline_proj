...
> **NOTE**: I believe you need to have PostgreSQL installed on your system in order for this to function properly. It can be downloaded [here](https://www.postgresql.org/download/).

> **PostgreSQL**: You will need to enter your actual password into the `psql_constants.py` file in order for it to properly utilize a local database.
